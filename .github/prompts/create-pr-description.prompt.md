---
mode: agent
description: Generates a pull request description for FSharp.Control.R3 by analyzing the current branch's changes and filling in the project's PR template.
---
