...
GitHub Actions |
:---: |
[![GitHub Actions](https://github.com/fsprojects/FSharp.Control.R3/workflows/Build%20main/badge.svg)](https://github.com/fsprojects/FSharp.Control.R3/actions?query=branch%3Amain) |
[![Build History](https://buildstats.info/github/chart/fsprojects/FSharp.Control.R3)](https://github.com/fsprojects/FSharp.Control.R3/actions?query=branch%3Amain) |

## NuGet

Package | Stable | Prerelease
--- | --- | ---
FSharp.Control.R3 | [![NuGet Badge](https://buildstats.info/nuget/FSharp.Control.R3)](https://www.nuget.org/packages/FSharp.Control.R3/) | [![NuGet Badge](https://buildstats.info/nuget/FSharp.Control.R3?includePreReleases=true)](https://www.nuget.org/packages/FSharp.Control.R3/)
...
```
$ tree src/FSharp.Control.R3/bin/
src/FSharp.Control.R3/bin/
└── Debug
    └── net8.0
        ├── FSharp.Control.R3.deps.json
        ├── FSharp.Control.R3.dll
        ├── FSharp.Control.R3.pdb
        └── FSharp.Control.R3.xml
...
git branch -M main
git remote add origin https://github.com/fsprojects/FSharp.Control.R3.git
...
[Unreleased]: https://github.com/fsprojects/FSharp.Control.R3/compare/v0.1.0...HEAD
...
- The [Github Action](https://github.com/fsprojects/FSharp.Control.R3/blob/main/.github/workflows/publish.yml) will handle the new tag:
...
- Set Source for "Build and deployment" on [GitHub Pages](https://github.com/fsprojects/FSharp.Control.R3/settings/pages) to `GitHub Actions`.
- Documentation is auto-deployed via [Github Action](https://github.com/fsprojects/FSharp.Control.R3/blob/main/.github/workflows/fsdocs-gh-pages.yml) to [Your GitHub Page](https://fsprojects.github.io/FSharp.Control.R3/)
